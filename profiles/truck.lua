-- file is a result of implementation diff over car.lua file
...
function setup()
  return {
    ...
    vehicle_height = 2.8, -- in meters, 2.5m is the height of van
    vehicle_width = 2.2, -- in meters, ways with narrow tag are considered narrower than 2.2m
